...
Model 2
Model 3
None, two or more have the same SSR.
Not yet answered.
检查答案 您的回答  重置 您的回答  保存 您的回答 您已经使用了最多3次中的 0次提交
Question 3.21
...
Model 2
Model 3
None, two or more have the same AIC.
Not yet answered.
检查答案 您的回答  重置 您的回答  保存 您的回答 您已经使用了最多3次中的 0次提交
Question 3.22
...
No
Not yet answered.
最后一次检查答案 您的回答  重置 您的回答  保存 您的回答 您已经使用了最多1次中的 0次提交
Question 3.23
...
Toss a coin to choose between two equally good models.
Stop here, I’ve found the best model.
Run one more model that might outperform all three models.
All three models are equally good. It doesn’t matter which I choose, and I don’t need to estimate any more models.
Not yet answered.
检查答案 您的回答  重置 您的回答  保存 您的回答 您已经使用了最多3次中的 0次提交
显示讨论 添加一个讨论帖
