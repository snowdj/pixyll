...
### auto series, which will be useful in forthcoming sessions on equation objects and regression. Auto series allow the user to create functions of series "on the fly" and can be useful in keeping your workfile parsimonious (i.e., to not have too many series objects).
